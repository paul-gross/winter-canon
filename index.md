...
|------|--------------|----------|
| [`./principles.md`](./principles.md) | Cross-cutting principles for any agent-facing markdown file — read before authoring or editing one | `canon:no-retro` · `canon:no-hard-wrap` · `canon:one-owner` · `canon:point-dont-duplicate` · `canon:minimal-examples` · `canon:parallel-structure` |
...
| [`./enforcement-channels.md`](./enforcement-channels.md) | Authoring or enforcing a standard meant to change how agents write — read before answering a recurring violation with more instructional prose | `canon:enforcement-channels` |
...
| [`./gardening-axes.md`](./gardening-axes.md) | Authoring or reviewing a harness, or building a standing tending pass — read before declaring what a project tends or resolving an axis to evaluate | `canon:gardening-axes` |
| [`./verifiability.md`](./verifiability.md) | Verifying a change to the canon repo itself — the declared verification methods and their ids | — |

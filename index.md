...
| [`./enforcement-channels.md`](./enforcement-channels.md) | Authoring or enforcing a standard — prose binds at judgment time while the target's own patterns, exemplars, and mechanical gates bind at write time; read before writing prose meant to change writer behavior | `canon:enforcement-channels` |
...
| [`./gardening-axes.md`](./gardening-axes.md) | Authoring or reviewing a harness, or building a standing tending pass — the required gardening-axes registry: what each axis declares, how a pass resolves one, and naming its absence as a gap | `canon:gardening-axes` |

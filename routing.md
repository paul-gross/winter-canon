...
These conventions hold for any harness — follow the one row that matches your task. Every rule carries a stable `canon:<slug>` id ([`./rule-shape.md`](./rule-shape.md)); the Rule ids column resolves a cited id to the file that owns it.
